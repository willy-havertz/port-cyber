  ...
  return (
    <Link to={`/writeups/${id}`} className="block">
      <motion.article
        ...
        className={`group block rounded-2xl overflow-hidden border transition-all duration-300 cursor-pointer ${
          theme === "dark"
      ...
      >
        ...
        <div className="p-5">
          ...
          >
            ...
            <span className="px-3 py-1.5 text-xs font-medium text-white bg-gradient-to-r from-green-500 to-emerald-600 rounded-lg group-hover:from-green-600 group-hover:to-emerald-700 transition-all">
              Read More
            </span>
          </div>
        </div>
