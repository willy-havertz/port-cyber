      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400">Upload, edit, and delete writeups</p>
          </button>
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400">Review and approve comments</p>
          </button>

          <div className="p-6 bg-white dark:bg-slate-800 rounded-lg shadow">
            <h2 className="text-xl font-bold mb-2">Security Scanner</h2>
            <p className="text-gray-600 dark:text-gray-400">Perform security scans</p>
          </div>
        </div>
      </main>
    </div>
...
export default function AdminWriteups() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      {/* Upload Form */}
      <form onSubmit={handleUpload} className="bg-white dark:bg-slate-800 p-8 rounded-lg shadow mb-8">
        ...
        <select value={platform} onChange={(e) => setPlatform(e.target.value)} className="w-full px-4 py-2 mb-4 border rounded-lg dark:bg-slate-700">
          <option>Try Hack Me</option>
          <option>Hack The Box</option>
        </select>

        <select value={difficulty} onChange={(e) => setDifficulty(e.target.value)} className="w-full px-4 py-2 mb-4 border rounded-lg dark:bg-slate-700">
          <option>Easy</option>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow">
        ...
        {writeups?.map((writeup: any) => (
          <div key={writeup.id} className="border-t p-6 flex justify-between items-center">
            <div>
              <h3 className="font-bold">{writeup.title}</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">{writeup.platform} - {writeup.difficulty}</p>
            </div>
